		...
		<form action="${ path }/board/update" method="POST" enctype="multipart/form-data">
			...
			<table id='tbl-board'>
				...
				<tr>
					<th>작성자</th>
					<td>
						<input type="text" name="writer" value="${ board.writerId }" readonly>
					</td>
				</tr>
				<tr>
					<th>첨부파일</th>
				...
				<tr>
					<th colspan="2"><input type="submit" value="수정"> <input type="button" onclick="location.replace('${path}/board/list')" value="목록으로">
					</th>
				</tr>
			</table>
		</form>
