...
--%>
	...
	<br>
	<fmt:formatNumber value="1.23" pattern="0.00" />
	<br>
	<br>
	...
	-->
	<fmt:formatNumber value="1.2376" pattern="#.##" />
	<br>
	<fmt:formatNumber value="1.2346" pattern="0.00" />
	<br>
	<br>
	...
	<br>
	통화 :
	<fmt:formatNumber type="currency" value="50000" currencySymbol="$" />
	<br>
	백분율
	<fmt:formatNumber type="percent" value="0.7" />
	<br>

	<h2>2. fmt:formatDate 태그</h2>
	<p>날짜와 시간 데이터의 출력 형식을 지정할 때 사용하는 태그이다.</p>
	...
	<ul>
		...
		<li>날짜와 시간(time스타일 지정하지만 타입이 date) : <fmt:formatDate type="date" value="${ date }" dateStyle="short" timeStyle="short" /></li>
